...
def parse_args():
    ...
    parser.add_argument('--attack', type=str, default='none',
                        help='Any attack to be placed on dataset')
    
    parser.add_argument('--attperc', type=int, default=0,
                        help='how much in percentage the data would be attaked')
    
    parser.add_argument('--TrainTest', type=str, default='train',
                        help='attack performed on the train set or only on the test set')
...
adj, features, labels, idx_train, idx_val, idx_test = get_dataset(args.dataset, args.pe_dim, 
                                                                  args.attack, args.attperc, args.TrainTest)
